...
<body>
 ...
 <div class="sign"><a style="text-decoration: none;" href='cart?id=${emp.id}&image=${emp.image}&name=${emp.name}&cost=${emp.cost}&description=${emp. description}'><button style="width: 224px;height: 36px;  background-color:hotpink;border: none;color: white;border-radius: 8px;text-decoration: none;margin-top: 185px;">AddCart</button> </a></div>
  <div class="buy"><a style="text-decoration: none;" href='order?id=${emp.id}&image=${emp.image}&name=${emp.name}&cost=${emp.cost}&description=${emp. description}'><button style="width: 224px;height: 36px;  background-color:hotpink;border: none;color: white;border-radius: 8px;text-decoration: none;margin-top:-35px;margin-left:281px;">BuyNow</button></a></div> 
   </c:forEach> 
 </body>
</html>